<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"D:\phpStudy\WWW\lamke\public/../application/admin\view\news\product_category.html";i:1527131996;s:71:"D:\phpStudy\WWW\lamke\public/../application/admin\view\public\meta.html";i:1526891573;s:73:"D:\phpStudy\WWW\lamke\public/../application/admin\view\public\footer.html";i:1521095340;}*/ ?>
﻿<!DOCTYPE HTML>
<html lang="cn">
<head>
<meta charset="utf-8">
			...
			<span class="l">
				...
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					...
					<tr class="text-c va-m">
						...
						<td class="td-manage">
							<a style="text-decoration:none" class="ml-5"  href="<?php echo url('editCategory',['id' => $vo['id']]); ?>" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
...
function product_del(obj,id){
	layer.confirm('确认删除后将删除分类下所有数据，删除的数据将无法恢复，请谨慎操作，确认删除吗？',function(index){
        $.post("<?php echo url('deleteCategory'); ?>",{id:id},function (res) {
			if (res==1){
                layer.msg('已删除该分类及其下级分类!',{icon:1,time:1000},function () {
