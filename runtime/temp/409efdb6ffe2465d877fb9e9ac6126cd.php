<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:74:"D:\phpStudy\WWW\lamke\public/../application/index\view\index\Feedback.html";i:1526975592;s:73:"D:\phpStudy\WWW\lamke\public/../application/index\view\public\header.html";i:1552642761;s:77:"D:\phpStudy\WWW\lamke\public/../application/index\view\public\nav_system.html";i:1526278997;s:71:"D:\phpStudy\WWW\lamke\public/../application/index\view\public\left.html";i:1526284889;s:73:"D:\phpStudy\WWW\lamke\public/../application/index\view\public\footer.html";i:1526029863;}*/ ?>
﻿<head>
    <meta charset="utf-8" />
  ...
  <script language="javaScript">function CheckJob()
{
  if (document.myform.title.value.length==""){
    alert ("<?php echo \think\Lang::get('msg_tips1'); ?>");
    document.myform.title.focus();
    return false;
  }
  if (document.myform.name.value.length==""){
    alert ("<?php echo \think\Lang::get('msg_tips2'); ?>");
    document.myform.name.focus();
    return false;
  }
  if (document.myform.tel.value.length==""){
    alert ("<?php echo \think\Lang::get('msg_tips3'); ?>");
  ...
  <div class="container">
   <div class="row">
    ...
    <div class="col-xs-12 col-sm-8 col-md-9" style="float:right">
     <div class="list_box">
      <h2 class="left_h"><?php echo \think\Lang::get('feedback'); ?></h2>
      <div class="feedback">
       <form id="myform" name="myform" class="form-horizontal" method="post" action="<?php echo url('save_mes'); ?>" onsubmit="return CheckJob()">
        <div class="form-group">
         <label for="title" class="col-sm-3 control-label"><?php echo \think\Lang::get('msg_title'); ?>：</label>
         <div class="col-sm-6">
          <input type="text" name="title" class="form-control" id="title" placeholder="<?php echo \think\Lang::get('msg_placeholder'); ?>" />
         </div>
        </div>
        <div class="form-group">
         <label for="username" class="col-sm-3 control-label"><?php echo \think\Lang::get('msg_name'); ?>：</label>
         <div class="col-sm-6">
          <input type="text" name="name" class="form-control" id="username" placeholder="<?php echo \think\Lang::get('msg_placeholder'); ?>" />
         </div>
        </div>
        <div class="form-group">
         <label for="tel" class="col-sm-3 control-label"><?php echo \think\Lang::get('msg_phone'); ?>：</label>
         <div class="col-sm-6">
          <input type="text" name="tel" class="form-control" id="tel" placeholder="<?php echo \think\Lang::get('msg_placeholder'); ?>" />
         </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
         <label for="contents" class="col-sm-3 control-label"><?php echo \think\Lang::get('msg_content'); ?>：</label>
         <div class="col-sm-6">
        ...
        <!--<div class="form-group">-->
         ...
         <!--<div class="col-xs-7 col-sm-2">-->
          <!--<input type="text" name="code" class="form-control" id="code" placeholder="<?php echo \think\Lang::get('msg_code'); ?>" />-->
         <!--</div>-->
         <!--<div class="col-xs-2 col-sm-1">-->
          <!--<img class="codeimg" src="__STATIC__/Picture/verify.html" onclick="this.src=this.src+&quot;?&quot;+Math.random()" />-->
         <!--</div>-->
        <!--</div>-->
    ...
    <ul class="left_nav_ul" id="firstpane">
        <li><a class="biglink" href="<?php echo url('index/system',['nav'=>'about']); ?>"><?php echo \think\Lang::get('nav_brief'); ?></a><span class="menu_head">+</span>
            <ul class="left_snav_ul menu_body">
            </ul>
        </li>
        <li><a class="biglink" href="<?php echo url('index/system',['nav'=>'contact']); ?>"><?php echo \think\Lang::get('contact_us'); ?></a><span class="menu_head">+</span>
            <ul class="left_snav_ul menu_body"></ul>
        </li>
        <li><a class="biglink" href="Our-service.html"><?php echo \think\Lang::get('advantage1'); ?></a><span class="menu_head">+</span>
            <ul class="left_snav_ul menu_body"></ul>
        </li>
    </ul>
</div>
