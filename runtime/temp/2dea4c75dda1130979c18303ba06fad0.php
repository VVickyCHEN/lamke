<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"D:\phpStudy\WWW\lamke\public/../application/admin\view\order\index.html";i:1526981638;s:71:"D:\phpStudy\WWW\lamke\public/../application/admin\view\public\meta.html";i:1526891573;s:73:"D:\phpStudy\WWW\lamke\public/../application/admin\view\public\footer.html";i:1521095340;}*/ ?>
﻿<!DOCTYPE HTML>
<html lang="cn">
<head>
<meta charset="utf-8">
...
<div class="page-container">
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
			...
			<tr class="text-c">
				...
				<td class="f-14 td-manage">
					...
					<span><u style="cursor:pointer" class="text-primary" onclick="member_show('<?php echo $vo['product']; ?>','<?php echo url("read"); ?>','<?php echo $vo['id']; ?>')" >详情</u></span>
		...
		<div style="text-align: center"><?php echo $order->render(); ?><div>
	</div>
</div>
	</form>
	<!--_footer 作为公共模版分离出去-->
